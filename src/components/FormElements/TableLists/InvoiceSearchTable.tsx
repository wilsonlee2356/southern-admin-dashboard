...
// import { invoiceArray } from "@/types/ObjectTypes/InvoiceType";

// const InvoiceSearchTable = ({ dataArray }: invoiceArray) => {
//   const [rows, setRows] = useState(dataArray);
//   const [selectedRows, setSelectedRows] = useState<string[]>([]);
//   const [totalSum, setTotalSum] = useState(
//     dataArray.reduce((sum, item) => sum + item.amount, 0),
//   );
...
//         selectedIds.includes(row.invoiceId.toString()),
//       );
//       const selectedSum = selectedData.reduce(
...
//             {
//               "bg-[#219653]/[0.08] text-[#219653]": params.value === "Paid",
//               "bg-[#D34053]/[0.08] text-[#D34053]": params.value === "Unpaid",
//               "bg-[#FFA70B]/[0.08] text-[#FFA70B]": params.value === "Pending",
//             },
//           )}
//         >
//           {params.value}
...
//       </div>
//       <DataGrid
//         className="border-none bg-[#F7F9FC] py-4 text-base text-dark dark:bg-dark-2 dark:text-white"
//         rows={dataArray}
//         columns={columns}
//         sx={{
